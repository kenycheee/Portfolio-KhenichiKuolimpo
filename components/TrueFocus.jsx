...
const TrueFocus = ({
  ...
  // 📏 Update posisi border sesuai kata aktif
  useEffect(() => {
    ...
    // 🔍 Dapatkan skala dari style transform (kalau ada)
    ...
    setFocusRect({
      x: (activeRect.left - parentRect.left) / scale,
      y: (activeRect.top - parentRect.top) / scale,
